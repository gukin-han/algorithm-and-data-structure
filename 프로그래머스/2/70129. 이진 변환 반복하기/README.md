...
<p>0과 1로 이루어진 문자열 s가 매개변수로 주어집니다. s가 "1"이 될 때까지 계속해서 s에 이진 변환을 가했을 때, 이진 변환의 횟수와 <web-highlight class="webhighlights-highlight" data-highlight-id="39a106ef-8a01-439b-9444-1ed30354bb82" data-highlight-split-type="both" data-highlight-id-extra="" markid="657c03ce472d14e2e367a81f" style="background-color: rgb(248, 252, 70); cursor: pointer;">변환 과정에서 제거된 모든 0의 개수</web-highlight>를 각각 배열에 담아 return 하도록 solution 함수를 완성해주세요.</p>

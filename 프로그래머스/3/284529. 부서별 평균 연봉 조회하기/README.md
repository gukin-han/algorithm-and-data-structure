...
<p><code>HR_DEPARTMENT</code>와 <code>HR_EMPLOYEES</code> 테이블을 이용해 <web-highlight class="webhighlights-highlight" data-highlight-id="c5a03e1f-db14-45bc-a377-4d7c8e09e4f9" data-highlight-split-type="both" data-highlight-id-extra="" markid="670685377eb0776402b14dff" media-type="blockquote" style="background-color: rgb(146, 255, 170); cursor: pointer;">부서별 평균 연봉을 조회</web-highlight>하려 합니다. 부서별로 부서 ID, 영문 부서명, 평균 연봉을 조회하는 SQL문을 작성해주세요.</p>
